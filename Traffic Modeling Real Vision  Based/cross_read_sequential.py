...
def leftsubtractImage(image, SIDE):
    if SIDE == 'upper':
        bg = cv2.imread('sequential/cross_left_upper.png')
        fgmask = image - bg
        fgmask = cv2.cvtColor(fgmask, cv2.COLOR_BGR2GRAY)
        #cv2.imshow("sub_upper", fgmask)

    elif SIDE == 'lower':
        bg = cv2.imread('sequential/cross_left_lower.png')
        fgmask = image - bg
        fgmask = cv2.cvtColor(fgmask, cv2.COLOR_BGR2GRAY)
        # cv2.imshow("bog_lower", fgmask)

    elif SIDE == 'right':
        bg = cv2.imread('sequential/cross_left_right.png')
        fgmask = image - bg
        fgmask = cv2.cvtColor(fgmask, cv2.COLOR_BGR2GRAY)
        # cv2.imshow("bog_right", fgmask)

    elif SIDE == 'left':
        bg = cv2.imread('sequential/cross_left_left.png')
        fgmask = image - bg
        fgmask = cv2.cvtColor(fgmask, cv2.COLOR_BGR2GRAY)
        # cv2.imshow("bog_left", fgmask)
...
def rightsubtractImage(image, SIDE):
    if SIDE == 'upper':
        bg = cv2.imread('sequential/cross_right_upper.png')
        fgmask = image - bg
        fgmask = cv2.cvtColor(fgmask, cv2.COLOR_BGR2GRAY)
        #cv2.imshow("sub_upper", fgmask)

    elif SIDE == 'lower':
        bg = cv2.imread('sequential/cross_right_lower.png')
        fgmask = image - bg
        fgmask = cv2.cvtColor(fgmask, cv2.COLOR_BGR2GRAY)
        # cv2.imshow("bog_lower", fgmask)

    elif SIDE == 'right':
        bg = cv2.imread('sequential/cross_right_right.png')
        fgmask = image - bg
        fgmask = cv2.cvtColor(fgmask, cv2.COLOR_BGR2GRAY)
        # cv2.imshow("bog_right", fgmask)

    elif SIDE == 'left':
        bg = cv2.imread('sequential/cross_right_left.png')
        fgmask = image - bg
        fgmask = cv2.cvtColor(fgmask, cv2.COLOR_BGR2GRAY)
        # cv2.imshow("bog_left", fgmask)
