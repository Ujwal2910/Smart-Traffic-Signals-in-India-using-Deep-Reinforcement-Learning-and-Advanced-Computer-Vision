...
def generate_routefile():
    ...
    <flow id="mixed1" begin="0" end="25000" number="8000" route="r0" type="mixed" departLane="random" departPosLat="random"/>
    ...
    <flow id="mixed4" begin="0" end="25000" number="0" route="r3" type="mixed" departLane="random" departPosLat="random"/>
    <flow id="mixed5" begin="0" end="25000" number="0" route="r4" type="mixed" departLane="random" departPosLat="random"/>
    <flow id="mixed6" begin="0" end="25000" number="0" route="r5" type="mixed" departLane="random" departPosLat="random"/>
    <flow id="mixed7" begin="0" end="25000" number="8000" route="r6" type="mixed" departLane="random" departPosLat="random"/>
    ...
    <flow id="mixed10" begin="0" end="25000" number="0" route="r9" type="mixed" departLane="random" departPosLat="random"/>
    <flow id="mixed11" begin="0" end="25000" number="0" route="r10" type="mixed" departLane="random" departPosLat="random"/>
    <flow id="mixed12" begin="0" end="25000" number="0" route="r11" type="mixed" departLane="random" departPosLat="random"/>
</routes>""", file=routes)
        lastVeh = 0
        vehNr = 0
...
#model = build_model()
model = load_model('lstm_phase_vlstm_new_stddev_time_20.h5')
...
while traci.simulation.getMinExpectedNumber() > 0:
    ...
    print("Output of NN : ")
    print(q_val)
    state = makeMove(phase,transition_time)
    experience.pop(0)
    experience.append(state)
